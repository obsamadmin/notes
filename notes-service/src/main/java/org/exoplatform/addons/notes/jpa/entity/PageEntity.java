...
package org.exoplatform.addons.notes.jpa.entity;
...
@NamedQueries({
    ...
    @NamedQuery(name = "wikiPage.countAllPagesBySyntax", query = "SELECT COUNT(p) FROM WikiPageEntity p WHERE p.syntax = :syntax OR p.syntax IS NULL")
})
