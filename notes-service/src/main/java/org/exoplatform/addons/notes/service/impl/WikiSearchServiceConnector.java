...
public class WikiSearchServiceConnector extends SearchServiceConnector {
  ...
  private static final Log LOG = ExoLogger.getLogger("org.exoplatform.addons.notes.service.impl.WikiSearchServiceConnector");
  ...
  public Collection<SearchResult> search(SearchContext context, String query, Collection<String> sites, int offset, int limit, String sort, String order) {
    ...
    try {
      PageList<org.exoplatform.addons.notes.service.search.SearchResult> wikiSearchPageList = wikiService.search(searchData);
      if (wikiSearchPageList != null) {
        List<org.exoplatform.addons.notes.service.search.SearchResult> wikiSearchResults = wikiSearchPageList.getAll();
        for (org.exoplatform.addons.notes.service.search.SearchResult wikiSearchResult : wikiSearchResults) {
   ...
   */
  private String getResultIcon(org.exoplatform.addons.notes.service.search.SearchResult wikiSearchResult) {
   ...
   * @throws Exception
   */
  private Page getPage(org.exoplatform.addons.notes.service.search.SearchResult result) throws Exception {
   ...
   * @return The string.
   */
  private String getPageDetail(org.exoplatform.addons.notes.service.search.SearchResult wikiSearchResult) {
   ...
   */
  private String getPagePermalink(SearchContext context, org.exoplatform.addons.notes.service.search.SearchResult wikiSearchResult) {
   ...
   */
  private SearchResult buildResult(SearchContext context, org.exoplatform.addons.notes.service.search.SearchResult wikiSearchResult) {
    try {
