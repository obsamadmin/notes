...
import org.exoplatform.addons.notes.WikiPortletPreference;
...
import org.exoplatform.addons.notes.service.WikiContext;
...
import org.exoplatform.addons.notes.webui.UIWikiPermissionForm.Scope;
import org.exoplatform.addons.notes.webui.control.UIAttachmentContainer;
import org.exoplatform.addons.notes.webui.control.action.AddPageActionComponent;
...
public class UIWikiPortlet extends UIPortletApplication {
  ...
  public void processRender(WebuiApplication app, WebuiRequestContext context) throws Exception {
    ...
    if (portletMode == PortletMode.VIEW) {
      ...
      if (WikiContext.ADDPAGE.equalsIgnoreCase(wikiPageParams.getParameter(WikiContext.ACTION))) {
      ...
      }else if (org.exoplatform.addons.notes.utils.Utils.COMPARE_REVISION.equalsIgnoreCase(wikiPageParams.getParameter(WikiContext.ACTION))) {
        ...
        if (pageInfoArea != null) {
          Event<UIComponent> xEvent = pageInfoArea.createEvent(org.exoplatform.addons.notes.utils.Utils.COMPARE_REVISION, Event.Phase.PROCESS, context);
          if (xEvent != null) {
