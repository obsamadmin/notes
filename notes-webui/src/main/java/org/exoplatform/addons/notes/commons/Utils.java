 ...
 */
package org.exoplatform.addons.notes.commons;
...
import org.exoplatform.addons.notes.resolver.PageResolver;
...
import org.exoplatform.addons.notes.service.impl.SessionManager;
...
public class Utils {
  ...
  public static String getURLFromParams(WikiPageParams params) throws Exception {
    ...
    return org.exoplatform.addons.notes.utils.Utils.getPermanlink(params, false);
  }
  ...
  public static Page getCurrentNewDraftWikiPage() throws Exception {
    WikiService wikiService = (WikiService) PortalContainer.getComponent(WikiService.class);
    return wikiService.getExsitedOrNewDraftPageById(null, null, org.exoplatform.addons.notes.utils.Utils.getPageNameForAddingPage());
  }
  ...
  public static WikiContext createWikiContext(UIWikiPortlet wikiPortlet) throws Exception {
    ...
    if (currentMode == WikiMode.ADDPAGE) {
      wikiContext.setPageName(org.exoplatform.addons.notes.utils.Utils.getPageNameForAddingPage());
    } else {
