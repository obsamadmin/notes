...
public class UIWikiPermalinkForm extends UIForm implements UIPopupComponent {
  ...
  protected boolean canPublicAndRetrictPage() throws Exception {
    return wikiService.canPublicAndRetrictPage(Utils.getCurrentWikiPage(), org.exoplatform.addons.notes.utils.Utils.getCurrentUser());
  }
  ...
  protected static String getPermanlink() throws Exception {
    ...
    return org.exoplatform.addons.notes.utils.Utils.getPermanlink(params, true);
  }
