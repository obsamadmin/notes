...
import org.exoplatform.addons.notes.webui.control.UIEditorTabs;
import org.exoplatform.addons.notes.webui.control.UISubmitToolBar;
import org.exoplatform.addons.notes.webui.core.UIWikiForm;
...
public class UIWikiPageEditForm extends UIWikiForm {
  ...
  protected void checkToDisplayNotification() throws Exception {
    ...
    if (wikiPortlet.getWikiMode() == WikiMode.EDITPAGE) {
      ...
      List<String> edittingUsers = org.exoplatform.addons.notes.utils.Utils.getListOfUserEditingPage(pageParams.getPageName());
  ...
  protected String getCancelDraftEvent() throws Exception {
    return org.exoplatform.addons.notes.commons.Utils.createFormActionLink(this, "CancelDraft", null);
  }
