...
import org.exoplatform.addons.notes.service.impl.WikiPageHistory;
import org.exoplatform.addons.notes.webui.UIWikiPageControlArea;
...
import org.exoplatform.addons.notes.webui.control.filter.IsEditAddModeFilter;
import org.exoplatform.addons.notes.webui.control.filter.IsEditAddPageModeFilter;
import org.exoplatform.addons.notes.webui.control.listener.UISubmitToolBarActionListener;
  ...
  public static class SavePageActionListener extends UISubmitToolBarActionListener<SavePageActionComponent> {
    ...
    protected void processEvent(Event<SavePageActionComponent> event) throws Exception {
      ...
      if (page != null) {
        ...
        if (org.exoplatform.addons.notes.utils.WikiConstants.WIKI_HOME_NAME.equals(page.getName())
        ...
        try {
          if (wikiMode == WikiMode.EDITPAGE) {
            ...
            try {
              ...
              if (contentDraftPage == null) {
                Map<String, WikiPageHistory> pageLogs = org.exoplatform.addons.notes.utils.Utils.getLogOfPage(parentPage.getName());
          ...
          org.exoplatform.addons.notes.utils.Utils.removeLogEditPage(pageParams, currentUser);
        } catch (Exception e) {
