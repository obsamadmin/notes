...
import org.exoplatform.addons.notes.webui.control.action.RemoveAttachmentActionComponent;
import org.exoplatform.addons.notes.webui.control.filter.RemoveAttachmentPermissionFilter;
...
public class UIWikiAttachmentUploadListForm extends UIForm {
  private static final Log log = ExoLogger.getLogger("org.exoplatform.addons.notes.webui.control.UIAttachmentUploadContainer");
  
  public static final String DOWNLOAD_ACTION = "DownloadAttachment";
  
  public static final String EXTENSION_TYPE = "org.exoplatform.addons.notes.webui.UIWikiAttachmentUploadListForm";
