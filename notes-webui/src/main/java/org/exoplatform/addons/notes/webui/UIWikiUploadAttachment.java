...
import org.exoplatform.addons.notes.webui.control.listener.UIWikiPortletActionListener;
import org.exoplatform.addons.notes.webui.core.UIWikiForm;
import org.exoplatform.addons.notes.webui.form.UIWikiFormUploadInput;
    ...
    public void processEvent(Event<UIWikiUploadAttachment> event) throws Exception {                 
      ...
      try {
        if (uploadResource != null) {
          ...
          if (fileName != null) {
            fileName = org.exoplatform.addons.notes.utils.Utils.normalizeUploadedFilename(fileName);
