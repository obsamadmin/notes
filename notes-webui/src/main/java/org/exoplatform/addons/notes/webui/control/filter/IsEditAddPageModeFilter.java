 ...
 */
package org.exoplatform.addons.notes.webui.control.filter;
...
public class IsEditAddPageModeFilter extends UIExtensionAbstractFilter {
  ...
  public IsEditAddPageModeFilter(String messageKey) {
  ...
  public boolean accept(Map<String, Object> context) throws Exception {
    ...
    return (wikiMode == WikiMode.EDITPAGE || wikiMode == WikiMode.ADDPAGE);
  }
